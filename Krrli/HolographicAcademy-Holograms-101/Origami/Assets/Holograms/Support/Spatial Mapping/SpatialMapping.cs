...
public class SpatialMapping : MonoBehaviour {
    ...
    private UnityEngine.VR.WSA.SpatialMappingRenderer spatialMappingRenderer;

    // Creates/updates environment colliders to work with physics.
    private UnityEngine.VR.WSA.SpatialMappingCollider spatialMappingCollider;
    ...
    public bool DrawVisualMeshes
    {
        ...
        set
        {
            ...
            if (drawVisualMeshes)
            {
                ...
                spatialMappingRenderer.renderState = UnityEngine.VR.WSA.SpatialMappingRenderer.RenderState.Visualization;
            }
            else
            {
                spatialMappingRenderer.renderState = UnityEngine.VR.WSA.SpatialMappingRenderer.RenderState.None;
            }
        }
    }
    ...
    void Start()
    {
        spatialMappingRenderer = gameObject.GetComponent<UnityEngine.VR.WSA.SpatialMappingRenderer>();
        spatialMappingRenderer.surfaceParent = this.gameObject;
        spatialMappingCollider = gameObject.GetComponent<UnityEngine.VR.WSA.SpatialMappingCollider>();
